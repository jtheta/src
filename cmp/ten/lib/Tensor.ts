...
// export default class Tensor extends dl.Tensor {
  // constructor(private raw: any, public size: Size) {
  //   if (Tensor.isLameTensor(raw)) {
  //     this.dl = raw
  //   } else {
  ...
  // }
  // static isLameTensor(target: any) {
  //   return target instanceof dl.Tensor
  // }
  // static fromLameTensor(raw: any {
  ...
  // }
  // sub(n: Tensor) {
  //   return new Tensor(this.dl.sub(n.dl), this.size)
  // }
